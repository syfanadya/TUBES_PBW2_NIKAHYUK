        ...
        <section id="pesanan-details" class="pesanan-details">
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="pesanan-info">
                            ...
                            <ul>
                                <li><a href="inforekening"><b>Info Rekening</b></a></li>
                                <li><a href="submitbukti"><b>Upload Bukti Pembayaran</b></a></li>
                                <li><a href="statuspembayaran"><b>Status Pembayaran</b></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                ?>
                                <tr>
                                    <td>
                                        <b>Waktu Pembayaran : </b><?php echo $row[1];?><br />
                                        <b>Status : </b><?php echo $row[2];?><br />
                                    </td>
                                </tr>
                                <?php
                  }
...
</html><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/statuspembayaran.blade.php ENDPATH**/ ?>