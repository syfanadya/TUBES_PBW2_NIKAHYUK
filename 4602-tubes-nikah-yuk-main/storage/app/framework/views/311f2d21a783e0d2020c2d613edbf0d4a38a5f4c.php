        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="dashboard#katalog">Katalog</a></li>
                    <li class="dropdown"><a href="dashboard#komentar"><span>Komentar</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="semuakomentar"><b>Semua Komentar</b></a></li>
                            <li><a href="tuliskomentar"><b>Tulis Komentar</b></a></li>
                        </ul>
                    </li>
                    <li><a class="nav-link scrollto" href="dashboard#pertanyaan">Pertanyaan</a></li>

                    <li class="dropdown"><a href="buatpesanan"><span>Pemesanan</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                    ...
                    <li class="dropdown"><a href="statuspembayaran"><span>Pembayaran</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="inforekening">Info Rekening</a></li>
                            <li><a href="submitbukti">Upload Bukti Pembayaran</a></li>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="pesanan-info">
                            ...
                            <ul>
                                <li><a href="statuspesanan"><strong>Status Pesanan</strong></a></li>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="pesanan-form">
                            <form enctype="multipart/form-data" class="form" action="prosespesanan" method="POST"
                                id="buatpesanan">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <select class="input-control" name="desain">
                                            <?php
                      $sql = "SELECT id_desain, nama_desain FROM desain";
                      $result = mysqli_query($conn, $sql);

                      while($row = mysqli_fetch_assoc($result)){
                        $id_desain =$row['id_desain'];
                        $nama_desain = $row['nama_desain'];
                        echo "<option value='$id_desain'>$nama_desain</option>";
                      }
                    ?>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Nama Lengkap : Lee Jongsuk"
                                            class="input-control" name="nama_pengantin_pria">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Nama Lengkap : Im Yoon Ah" class="input-control"
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Nomor : 0829-0080-0705" class="input-control"
                                            name="nomor_hp">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Lokasi Acara" class="input-control"
                                            name="lokasi_acara">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Waktu Acara : 08:00 - selesai"
                                            class="input-control" name="waktu_acara">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group w50">
                                        <input type="text" placeholder="Nama Ayah : Abdul" class="input-control"
                                            name="nama_ayah_pengantin_pria">
                                    </div>
                                    <div class="input-group w50">
                                        <input type="text" placeholder="Nama Ibu : Maria" class="input-control"
                                            name="nama_ibu_pengantin_pria">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group w50">
                                        <input type="text" placeholder="Nama Ayah : Situmorang" class="input-control"
                                            name="nama_ayah_pengantin_wanita">
                                    </div>
                                    <div class="input-group w50">
                                        <input type="text" placeholder="Nama Ibu : Riana" class="input-control"
                                            name="nama_ibu_pengantin_wanita">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <textarea
                                            placeholder="Ayat Kitab Suci : “Wanita yang baik adalah untuk lelaki yang baik. Lelaki yang baik untuk wanita yang baik pula (begitu pula sebaliknya). Bagi mereka ampunan dan reski yang melimpah (yaitu Surga).” (QS. An Nuur (24):26)"
                                            class="input-control" name="ayat_kitab_suci"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group w50">
                                        <input type="text" placeholder="No.Rek Pengantin Pria" class="input-control"
                                            name="norek_pengantin_pria">
                                    </div>
                                    <div class="input-group w50">
                                        <input type="text" placeholder="No.Rek Pengantin Wanita" class="input-control"
                                            name="norek_pengantin_wanita">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        <label>Lagu</label>
                                        <input type="text" placeholder="Judul Lagu : It's You - Sezairi"
                                            class="input-control" name="lagu">
                                    </div>
                                </div>
...
</html><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/buatpesanan.blade.php ENDPATH**/ ?>