...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        header("Location: editpesanan?id=$id");
        exit();
    } else {
...
<body>
    ...
    <form action="proseseditpesanan?id=<?php echo $id ?>" method="POST">
        <?php echo csrf_field(); ?>
...
?>
</body><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/editstatuspesanan.blade.php ENDPATH**/ ?>