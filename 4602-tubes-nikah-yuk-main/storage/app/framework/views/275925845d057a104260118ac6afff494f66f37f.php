...
<body>
  ...
  <script>
    ...
    music.src = "<?php echo e(asset('assetswedding/itsyou.mp3')); ?>";
    music.loop = true;
    music.autoplay = true;
...
<section class="home-section" id="home">
  <!-- SLIDE START -->
  <div class="slide active" style="background-image: url('<?php echo e(asset('assetswedding/slide-1.jpg')); ?>');">
    <div class="container">
  ...
  <!-- SLIDE END -->
  <!-- SLIDE START -->
  <div class="slide" style="background-image: url('<?php echo e(asset('assetswedding/slide-2.jpg')); ?>');">
    <div class="container">
      <div class="row align-items-center">
        <div class="home-content">
          <p>We are Getting Married</p>
  ...
  <!-- SLIDE END -->
  <!-- SLIDE START -->
  <div class="slide" style="background-image: url('<?php echo e(asset('assetswedding/slide-3.jpg')); ?>');">
    <div class="container">
      <div class="row align-items-center">
        <div class="home-content">
          <p>We are Getting Married</p>
...
<section class="couple-section" id="couple">
  <div class="container">
    ...
    <div class="row">
      <div class="couple" >
        <img src="<?php echo e(asset('assetswedding/groom.jpg')); ?>" alt="happy couple">
        <h3>Lee Jongsuk</h3>
        <p>Putra Kedua</p>
      ...
      <div class="couple" >
        ...
        <img src="<?php echo e(asset('assetswedding/bride.jpg')); ?>" alt="happy couple">
        <h3>Im Yoon Ah</h3>
        <p>Putri Pertama</p>
...
<section class="ayat-section">
  <div class="container">
    <div class="background" style="background-image: url('<?php echo e(asset('assetswedding/ayat-background.png')); ?>');">
    <div class="row">
      <div class="section-title">
...
<section class="amplop-section">
  <div class="container">
    ...
    <div class="row">
      <div class="bank">
        <img src="<?php echo e(asset('assetswedding/logobank1.png')); ?>" alt="bank">
      ...
      <div class="bank">
        <img src="<?php echo e(asset('assetswedding/logobank2.png')); ?>" alt="bank">
        <div class="norek-copy">
    ...
    <div class="row">
      ...
      <div class="gallery-item">
        <div class="gallery-item-inner">
          <img src="<?php echo e(asset('assetswedding/thumb/1.jpg')); ?>" data-large="gallery/large/1.jpg" alt="couple gallery">
        </div>
      </div>
      <!-- GALLERY ITEM END -->
      <!-- GALLERY ITEM START -->
      <div class="gallery-item">
        <div class="gallery-item-inner">
          <img src="<?php echo e(asset('assetswedding/thumb/2.jpg')); ?>" data-large="gallery/large/2.jpg" alt="couple gallery">
        </div>
      </div>
      <!-- GALLERY ITEM END -->
      <!-- GALLERY ITEM START -->
      <div class="gallery-item">
        <div class="gallery-item-inner">
          <img src="<?php echo e(asset('assetswedding/thumb/3.jpg')); ?>" data-large="gallery/large/3.jpg" alt="couple gallery">
        </div>
      </div>
      <!-- GALLERY ITEM END -->
      <!-- GALLERY ITEM START -->
      <div class="gallery-item">
        <div class="gallery-item-inner">
          <img src="<?php echo e(asset('assetswedding/thumb/4.jpg')); ?>" data-large="gallery/large/4.jpg" alt="couple gallery">
        </div>
      </div>
      <!-- GALLERY ITEM END -->
      <!-- GALLERY ITEM START -->
      <div class="gallery-item">
        <div class="gallery-item-inner">
          <img src="<?php echo e(asset('assetswedding/thumb/5.jpg')); ?>" data-large="gallery/large/5.jpg" alt="couple gallery">
        </div>
      </div>
      <!-- GALLERY ITEM END -->
      <!-- GALLERY ITEM START -->
      <div class="gallery-item">
        <div class="gallery-item-inner">
          <img src="<?php echo e(asset('assetswedding/thumb/6.jpg')); ?>" data-large="gallery/large/6.jpg" alt="couple gallery">
        </div>
      </div>
      <!-- GALLERY ITEM END -->
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="ucapan-form">
        <form class="form" action="proses" method="POST">
          <div class="row">
    ...
    <div class="row">
      <div class="footer-content">
        <div class="couple-name">
          <img src="<?php echo e(asset('assetswedding/flower-circle.png')); ?>" alt="Wedding Couple">
          <h2>Jongsuk
            <span>&</span>
              Yoona
          </h2>
...
<div class="gallery-popup">
  <div class="gp-container">
    ...
    <img src="<?php echo e(asset('assetswedding/1.jpg')); ?>" class="gp-img" alt="gallery img">
...
<?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/invitation1.blade.php ENDPATH**/ ?>