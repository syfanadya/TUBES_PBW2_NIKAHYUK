  ...
  <body>
    <section class="hero" id="home">
      <main class="content">
        ...
        <!-- <img class="ataskiri" src="./aset/a atas kiri.png" alt="" />
        <img class="bawahkanan" src="./aset/b kanan bawah.png" alt="" /> -->
        <img class="left-bg" src="<?php echo e(asset('assetswedding/desain3/left.png')); ?>" alt="" />
        <img class="prewed" src="<?php echo e(asset('assetswedding/desain3/foto.png')); ?>" alt="" />
        <img class="right-bg" src="<?php echo e(asset('assetswedding/desain3/right.png')); ?>" alt="" />
        <div class="text">
    ...
    <section class="slide3">
      ...
      <div class="slide-three2">
        <div class="pria">
          <img src="<?php echo e(asset('assetswedding/desain3/pria.png')); ?>" alt="" />
          <p class="text1">Roni Evander</p>
          <p class="text2">Putra Kedua</p>
          <p class="text2">Bapak Abdul & Ibu Maria</p>
        </div>
        <div class="love">
          <img src="<?php echo e(asset('assetswedding/desain3/love.png')); ?>" alt="" />
        </div>
        <div class="wanita">
          <img src="<?php echo e(asset('assetswedding/desain3/wanita.png')); ?>" alt="" />
    ...
    <section class="slide5">
      ...
      <div class="galeri1">
        <img src="<?php echo e(asset('assetswedding/desain3/galery1.png')); ?>" alt="" />
        <img src="<?php echo e(asset('assetswedding/desain3/galery2.png')); ?>" alt="" />
        <img src="<?php echo e(asset('assetswedding/desain3/galery3.png')); ?>" alt="" />
      </div>
      <div class="galeri2">
        <img src="<?php echo e(asset('assetswedding/desain3/galery4.png')); ?>" alt="" />
        <img src="<?php echo e(asset('assetswedding/desain3/galery5.png')); ?>" alt="" />
        <img src="<?php echo e(asset('assetswedding/desain3/galery6.png')); ?>" alt="" />
      </div>
    </section>
    <!-- =============================== -->
    <section class="slide6">
      ...
      <div class="resep">
        <div class="icon1">
          <img src="<?php echo e(asset('assetswedding/desain3/resep1.png')); ?>" alt="" />
          <p>Minggu, 17 April 2023</p>
        </div>
        <div class="icon2">
          <img src="<?php echo e(asset('assetswedding/desain3/resep2.png')); ?>" alt="" />
          <p>Gedung Tokong Nanas, Bandung</p>
        </div>
        <div class="icon3">
          <img src="<?php echo e(asset('assetswedding/desain3/resep3.png')); ?>" alt="" />
    ...
    <section class="slide7">
      ...
      <div class="money">
        <div class="bank1">
          <img src="<?php echo e(asset('assetswedding/desain3/bca.png')); ?>" alt="" />
          <div class="copy">
            <p id="myText">1234567890</p>
            <button onclick="copyText()">
              <img src="<?php echo e(asset('assetswedding/desain3/copy.png')); ?>" alt="" />
            </button>
          </div>
          <p>a/n Roni Evander</p>
        </div>
        <div class="bank2">
          <img src="<?php echo e(asset('assetswedding/desain3/bni.png')); ?>" alt="" />
          <div class="copy">
...
<?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/undangan3.blade.php ENDPATH**/ ?>