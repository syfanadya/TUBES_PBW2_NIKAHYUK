        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="statuspesanan"><span>Pemesanan</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="pesanan-form">
                            <form enctype="multipart/form-data" class="form" action="prosespembayaran"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
</html><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/submitbukti.blade.php ENDPATH**/ ?>