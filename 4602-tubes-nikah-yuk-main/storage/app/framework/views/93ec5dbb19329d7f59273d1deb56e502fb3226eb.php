        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    //mysqli_query menjalankan perintah SQL terhadap database
                    $result = mysqli_query($conn,$sql);
                    //mysqli_num_rows menghitung jumlah baris (record) yang dikembalikan oleh sebuah perintah SELECT pada objek koneksi MySQLi.
            ...
            <div class="container">
                <div class="row gy-4">
                  ...
                  $sql ="SELECT 
                          ...
                          FROM pesanan
                          JOIN desain 
                          ON pesanan.id_desain = desain.id_desain
...
</html><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/statuspesanan.blade.php ENDPATH**/ ?>