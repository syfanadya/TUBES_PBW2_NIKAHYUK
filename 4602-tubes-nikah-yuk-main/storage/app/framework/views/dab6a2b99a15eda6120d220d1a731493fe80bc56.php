            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="dashboard#komentar"><span>Komentar</span> <i
                        ...
                        <ul>
                            <li><a href="semuakomentar">Semua Komentar</a></li>
                            <li><a href="tuliskomentar">Tulis Komentar</a></li>
                        </ul>
                    </li>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="pesanan-form">
                            <form enctype="multipart/form-data" action="proseskomen" class="form" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
</html><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/tuliskomentar.blade.php ENDPATH**/ ?>