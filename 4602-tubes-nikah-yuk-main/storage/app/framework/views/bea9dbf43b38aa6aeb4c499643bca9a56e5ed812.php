...
<body>
    ...
    <a class="keluar" href="logout">Keluar</a>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <?php echo $row[31]?>
                <?php if ($row[31] == 1): ?>
                <a class="edit" href="desainundangan/desain1?id=<?php echo $row[2]; ?>"
                    class="edit" target="_blank">Lihat</a>
                <?php elseif ($row[31] == 2): ?>
                <a target="_blank" class="edit" href="desainundangan/desain2/index?id= <?php echo $row[2]; ?>"
                    class="edit" target="_blank">Lihat</a>
                <?php elseif ($row[31] == 3): ?>
                <a class="edit" href="desainundangan/desain3/index?id=<?php echo $row[2]; ?>" class="edit" target="_blank">Lihat</a>
                <?php endif; ?>
            ...
            <td>
                ...
                <img class="bayar" src="<?php echo e(asset('asetdashboard/bukti_1.png')); ?>" alt="">
            ...
            <td>
                <?php echo $row[25]?>
                <a class="edit" href="editstatuspembayaran?id=<?php echo $row[26]; ?>" class="edit">Edit</a>
            </td>
            <td>
                <b>Status Pesanan :</b><?php echo $row[22]?><br />
                <b>Link Undangan :</b><?php echo $row[30]?>
                <a class="edit" href="editstatuspesanan?id=<?php echo $row[2]; ?>" class="edit">Edit</a>
            </td>
        </tr>
        <?php
                    }
...
</html><?php /**PATH C:\Freelance\4602-tubes-nikah-yuk\4602-tubes-nikah-yuk-main\resources\views/admin.blade.php ENDPATH**/ ?>