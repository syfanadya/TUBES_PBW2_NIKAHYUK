    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <?php elseif ($row[31] == 2): ?>
                <a target="_blank" class="edit" href="desainundangan/desain2?id= <?php echo $row[2]; ?>"
                    class="edit" target="_blank">Lihat</a>
                <?php elseif ($row[31] == 3): ?>
                <a class="edit" href="desainundangan/desain3?id=<?php echo $row[2]; ?>" class="edit" target="_blank">Lihat</a>
                <?php endif; ?>
...
</html><?php /**PATH D:\laragon\www\4602-tubes-nikah-yuk-main\resources\views/admin.blade.php ENDPATH**/ ?>