...
.slide8 {
  ...
  display: flex;
  align-items: center;
  background-image: "url('{{ asset('assetswedding/bg.png') }}')";
  ...
  <body>
    <section class="hero" id="home">
      <main class="content">
        ...
        <img class="kiriatas" src="{{ asset('assetswedding/desain2/kiri atas.png') }}" alt="" />
        <img class="kiritengah" src="{{ asset('assetswedding/desain2/kiri tengah.png') }}" alt="" />
        <img class="kiribawah" src="{{ asset('assetswedding/desain2/kiri bawah.png') }}" alt="" />
        <img class="tengahatas" src="{{ asset('assetswedding/desain2/tengah atas.png') }}" alt="" />
        <img class="kananatas" src="{{ asset('assetswedding/desain2/kanan atas.png') }}" alt="" />
        <img class="kanantengah" src="{{ asset('assetswedding/desain2/kanan tengah.png') }}" alt="" />
        <img class="kananbawah" src="{{ asset('assetswedding/desain2/kanan bawah.png') }}" alt="" />
        <img class="prewed" src="{{ asset('assetswedding/desain2/foto.png') }}" alt="" />
        <div class="text">
    ...
    <section class="slide3">
      ...
      <div class="slide-three2">
        <div class="pria">
          <img src="{{ asset('assetswedding/desain2/pria.png') }}" alt="" />
          <p class="text1">Roni Evander</p>
          <p class="text2">Putra Kedua</p>
          <p class="text2">Bapak Abdul & Ibu Maria</p>
        </div>
        <div class="love">
          <img src="{{ asset('assetswedding/desain2/love.png') }}" alt="" />
        </div>
        <div class="wanita">
          <img src="{{ asset('assetswedding/desain2/wanita.png') }}" alt="" />
    ...
    <section class="slide5">
      ...
      <div class="galeri1">
        <img src="{{ asset('assetswedding/desain2/galery1.png') }}" alt="" />
        <img src="{{ asset('assetswedding/desain2/galery2.png') }}" alt="" />
        <img src="{{ asset('assetswedding/desain2/galery3.png') }}" alt="" />
      </div>
      <div class="galeri2">
        <img src="{{ asset('assetswedding/desain2/galery4.png') }}" alt="" />
        <img src="{{ asset('assetswedding/desain2/galery5.png') }}" alt="" />
        <img src="{{ asset('assetswedding/desain2/galery6.png') }}" alt="" />
      </div>
    </section>
    <!-- =============================== -->
    <section class="slide6">
      ...
      <div class="resep">
        <div class="icon1">
          <img src="{{ asset('assetswedding/desain2/resep1.png') }}" alt="" />
          <p>Minggu, 17 April 2023</p>
        </div>
        <div class="icon2">
          <img src="{{ asset('assetswedding/desain2/resep2.png') }}" alt="" />
          <p>Gedung Tokong Nanas, Bandung</p>
        </div>
        <div class="icon3">
          <img src="{{ asset('assetswedding/desain2/resep3.png') }}" alt="" />
    ...
    <section class="slide7">
      ...
      <div class="money">
        <div class="bank1">
          <img src="{{ asset('assetswedding/desain2/bca.png') }}" alt="" />
          <div class="copy">
            <p id="myText">1234567890</p>
            <button onclick="copyText()">
              <img src="{{ asset('assetswedding/desain2/copy.png') }}" alt="" />
            </button>
          </div>
          <p>a/n Roni Evander</p>
        </div>
        <div class="bank2">
          <img src="{{ asset('assetswedding/desain2/bni.png') }}" alt="" />
          <div class="copy">
...
var music = new Audio();
music.src = "{{ asset('assetswedding/desain2/only.mp3') }}";
music.loop = true;
