...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <div class="input-group">
                <input type="password" placeholder="Konfrimasi Kata Sandi" name="cpassword" id="cpassword"
            ...
            <p style="color: red; margin-top: 1rem;">Email atau Kata Sandi yang anda masukkan tidak sesuai silahkan cek
                ulang</p>
        </form>
    </div>
    <script>
