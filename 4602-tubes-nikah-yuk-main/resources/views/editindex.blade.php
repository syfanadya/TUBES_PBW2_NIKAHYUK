...
<body>
    <section class="hero" id="home">
        ...
        <img class="bawahkanan" src="./aset/b kanan bawah.png" alt="" /> -->
            <img class="left-bg" src="./aset/left.png" alt="" />
            <img class="prewed" src="../../file_pesananuser/fotoprewedd/<?php echo $row[8];?>" alt="" />
            <img class="right-bg" src="./aset/right.png" alt="" />
            <div class="text">
    ...
    <section class="slide3">
        ...
        <div class="slide-three2">
            <div class="pria">
                ...
                <p class="text2">Putra dari</p>
                <p class="text2">Bapak <?php echo $row[18];?> & Ibu <?php echo $row[19];?></p>
            </div>
            <div class="love">
            ...
            <div class="wanita">
                ...
                <p class="text2">Putri dari</p>
                <p class="text2">Bapak <?php echo $row[20];?> & Ibu <?php echo $row[21];?></p>
            </div>
        </div>
    </section>
    <!-- ======================== -->
